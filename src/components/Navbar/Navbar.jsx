        ...
        <div className="navbar-items">
            <nav>
                ...
                <NavLink className="nav-buttons" to="/Explore">
                    <img className="nav-logo" src={explore} alt="explore"></img>
                </NavLink>
                <NavLink className="nav-buttons" to="/MyLibrary">
                    <img className="nav-logo" src={myLibrary} alt="My Library"></img>
                </NavLink>
                <NavLink className="nav-buttons" to="/UserProfile">
                    <img className="nav-logo" src={UserProfile} alt="Profil"></img>
                </NavLink>
            </nav>
        </div>
